...
function showSpinner() {
  ...
  // parent.document.getElementById('Video-Display').style.height = document.getElementById('videoOutput').style.height;
  // console.log('###########################  '+document.getElementById('videoOutput').style.height);
}
