        ...
        try:
            ...
            if CH != []:
                ...
                if state == 'SET_DF_STATUS' :
                    ...
                    print("my_test_DF_STATUS in SET_DF_STATUS**********\n")
                    time.sleep(3);
                    print(DAI.all_app_list)
                    for app in DAI.all_app_list:
                        origin_name = 'GeoData_O'+ str(DAI.all_app_list.index(app)+1)
                        set_alias(origin_name, app);
                        print(origin_name+ ' ' + app)

                if state == 'RESUME' :
                    print("my_test_DF_STATUS in RESUME**********\n")
                    time.sleep(3);
                    print(DAI.all_app_list)
                    for app in DAI.all_app_list:
                        origin_name = 'GeoData_O'+ str(DAI.all_app_list.index(app)+1)
