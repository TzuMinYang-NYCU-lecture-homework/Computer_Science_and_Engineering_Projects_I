...
add_to_screen Timer2 "$python3 ./da/Timer2/timer2.py"
...
#add_to_screen OrchidHouse "$python3 ./da/Map/FetchData/FetchData_OrchidHouse/DAI.py"
#add_to_screen SP_kAir "$python3 ./da/Map/FetchData/FetchData_ScienceParkAir/DAI.py"
#add_to_screen SP_Water "$python3 ./da/Map/FetchData/FetchData_ScienceParkWater/DAI.py"
#add_to_screen Weather "$python3 ./da/Map/FetchData/FetchData_Weather/DAI.py"
